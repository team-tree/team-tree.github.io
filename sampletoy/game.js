// Jonathan Shiery
// Team Tree
// Mod 1: Added gray to cycle of click colors.
// Mod 2: Changed status text color to green.
// Mod 3: The color of the bead's border changes when clicking a bead.
// Mod 4: Changed grid size to 10x10.
// Mod 5: Added a white glow to the grid box.
// Mod 6: The bead's borders start out as white.
// Mod 7: The status line tells which row and column the selected bead is in.
// Mod 8: Randomly selects one of two sounds to play when clicking a bead.
// Mod 9: Pressing any key changes all the beads to white.
...
PS.touch = function( x, y, data, options ) {
	...
	// Changes status to the row and column of the selected bead
	PS.statusText("Row " + (row + 1) + ", Column " + (column + 1));
...
PS.keyDown = function( key, shift, ctrl, options ) {
	"use strict"; // Do not remove this directive!
		...
		PS.borderColor(PS.ALL, PS.ALL, PS.COLOR_WHITE);
		PS.data(PS.ALL, PS.ALL, PS.COLOR_BLACK);
