...
PS.keyUp = function( key, shift, ctrl, options ) {
    ...
    var myFunc = function () {
        ...
        fadeOut = PS.timerStart (15, restartFunc);
    ...
    var restartFunc = function () {
        ...
        PS.timerStop (fadeOut);

        noMoreFade = PS.timerStart(15, noMoreFunc);
    }

    var noMoreFunc = function () {
        PS.fade( PS.ALL, PS.ALL, 0 );
        PS.borderFade(PS.ALL, PS.ALL, 0);
        PS.timerStop(noMoreFade);
    ...
    var fadeOut;
    var noMoreFade;
    var myTimer = PS.timerStart (15, myFunc );
